...
export function ToastProvider({ children }) {
  ...
  // The portal exists only after mount: build-time prerendering has no
  // document to target, so the server renders nothing here — and the client's
  // FIRST render must match it for hydration to succeed. No toast can be
  // showing before mount anyway.
