        ...
        <div className="flex items-center justify-center md:justify-end">
          <div className="glass-panel w-full max-w-md p-10 rounded-3xl shadow-2xl animate-fade-in" style={{ animationDelay: '150ms' }}>
            ...
            <div className="space-y-5">
              ...
              <button onClick={handleLogin} className="w-full py-4 mt-2 bg-primary text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue/20 transform hover:-translate-y-0.5 transition-all duration-200">
                Accéder à l'espace
              </button>
            </div>
