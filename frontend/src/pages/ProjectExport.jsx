        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-8 flex flex-col items-start text-left">
                <div className="h-12 w-12 bg-pink/15 text-pink rounded-full flex items-center justify-center mb-6">
          ...
          <div className="mt-12">
            ...
            <div className="bg-primary rounded-2xl p-6 overflow-x-auto shadow-inner">
              <pre className="text-xs text-white/80 font-mono leading-relaxed">{projectJson}</pre>
            </div>
          </div>
        </>
      ) : (
