...
export default function AddTile({
  ...
  return (
    <button
      onClick={onClick}
      className={`group rounded-3xl border-2 border-dashed border-secondary flex flex-col items-center justify-center cursor-pointer hover:border-blue hover:bg-blue/5 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-blue/40 focus-visible:ring-offset-2 ${className}`.trim()}
    >
