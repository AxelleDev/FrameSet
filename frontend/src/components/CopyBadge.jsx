...
export default function CopyBadge({ isCopied, copiedLabel = 'Copied!', defaultLabel = 'Copy' }) {
  return (
    <span className="px-3 py-1 bg-surface/90 rounded-full text-[10px] font-bold uppercase tracking-wider text-primary transform scale-90 group-hover:scale-100 group-active:scale-100 transition-transform">
