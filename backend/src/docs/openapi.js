    ...
    schemas: {
      ...
      BrushNorm: {
        ...
        properties: {
          ...
          opacity: { type: 'number', format: 'float', nullable: true, minimum: 0, maximum: 1, example: 1 }
        }
      },
      TypographyNorm: {
        type: 'object',
      ...
      PaletteColor: {
        ...
        properties: {
          ...
          hex: { type: 'string', pattern: '^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$', example: '#112233' }
        },
        required: ['hex']
      },
      Project: {
        ...
        properties: {
          ...
          typographyNorms: { type: 'array', items: { $ref: '#/components/schemas/TypographyNorm' } },
      ...
      CreatedProject: {
        ...
        properties: {
          ...
          palette: { type: 'array', items: { $ref: '#/components/schemas/PaletteColor' }, example: [] }
        }
      },
      Pagination: {
        type: 'object',
  ...
  paths: {
    ...
    '/api/auth/login': {
      post: {
        ...
        responses: {
          200: {
            description: 'Signed in; sets `frameset_access_token` and `frameset_refresh_token` cookies.',
            content: { 'application/json': { schema: { $ref: '#/components/schemas/User' } } }
          },
          400: { $ref: '#/components/responses/ValidationError' },
    ...
    '/api/auth/verify': {
      post: {
        ...
        responses: {
          200: { description: 'Verified.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Success' } } } },
          400: { $ref: '#/components/responses/ValidationError' },
          429: { $ref: '#/components/responses/RateLimited' }
        }
      }
    ...
    '/api/auth/forgot-password': {
      post: {
        ...
        description: 'Always responds identically whether or not the email exists (anti-enumeration).',
        parameters: [CSRF_HEADER],
        requestBody: {
          required: true,
          content: {
    ...
    '/api/auth/refresh': {
      post: {
        ...
        parameters: [CSRF_HEADER],
        responses: {
          200: { description: 'Tokens rotated; new cookies set.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Success' } } } },
          401: { $ref: '#/components/responses/Unauthorized' }
        }
      }
    },
    '/api/auth/logout': {
      post: {
        ...
        parameters: [CSRF_HEADER],
        responses: {
          200: { description: 'Signed out.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Success' } } } }
        }
      }
    },
      ...
      get: {
        ...
        responses: {
          200: {
            ...
            content: { 'application/json': { schema: { type: 'object', properties: { count: { type: 'integer', example: 42 } } } } }
          }
        }
      }
    },
          ...
          200: {
            ...
            content: {
              'application/json': {
                schema: {
                  type: 'object',
                  properties: { success: { type: 'boolean' }, passwordUpdatedAt: { type: 'string', format: 'date-time' } }
                }
              }
            }
          },
      ...
      post: {
        ...
        responses: {
          200: {
            ...
            content: {
              'application/json': {
                schema: { type: 'object', properties: { success: { type: 'boolean' }, user: { $ref: '#/components/schemas/Profile' } } }
              }
            }
          },
          400: { $ref: '#/components/responses/ValidationError' },
    ...
    '/api/projects': {
      get: {
        ...
        responses: {
          200: { description: 'A page of projects.', content: { 'application/json': { schema: { $ref: '#/components/schemas/ProjectsPage' } } } },
          401: { $ref: '#/components/responses/Unauthorized' }
        }
      },
      post: {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['name'],
                properties: { name: { type: 'string', minLength: 2, maxLength: 50, example: 'Neo-Tokyo Editorial' } }
              }
            }
          }
        },
    ...
    '/api/projects/{id}': {
      patch: {
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: { type: 'object', required: ['name'], properties: { name: { type: 'string', minLength: 2, maxLength: 50 } } }
            }
          }
        },
        responses: {
          200: {
            description: 'Renamed.',
            content: { 'application/json': { schema: { type: 'object', properties: { success: { type: 'boolean' }, name: { type: 'string' } } } } }
          },
          400: { $ref: '#/components/responses/ValidationError' },
          401: { $ref: '#/components/responses/Unauthorized' },
    ...
    '/api/projects/{projectId}/typography-norms/{normId}': {
      put: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/TypographyNorm' } } }
        },
        responses: {
          200: { description: 'Updated.', content: { 'application/json': { schema: { $ref: '#/components/schemas/Success' } } } },
          400: { $ref: '#/components/responses/ValidationError' },
    ...
    '/api/projects/{id}/palette': {
      post: {
        ...
        requestBody: {
          required: true,
          description: 'Ordered array of up to 50 colors. Existing colors keep their id; new ones omit it.',
          content: {
            'application/json': {
              schema: { type: 'array', maxItems: 50, items: { $ref: '#/components/schemas/PaletteColor' } }
            }
          }
        },
        responses: {
